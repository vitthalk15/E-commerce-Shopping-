  ...
  return (
    <div>
        <div className='container py-16 grid-cols-2'>
            <h2 className='navbar_link font-medium text-2xl pb-4'>Testimonials</h2>
            <div className='grid lg:grid-cols-[300px,1fr] gap-4'>
                <div className='border border-gray-300 rounded-2xl grid place-self-center p-6 lg:p-0'>
                    <div className='text-center flex flex-col items-center gap-1'>
                        ...
                        <p className='max-w-[200px] text-gray-500'>There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain...</p>
                    </div>
                </div>
